...
.method protected updateSpnDisplay(Z)V
    ...
    .line 3420
    .local v17, simRecords:Lcom/android/internal/telephony/gsm/SIMRecords;
    move-object/from16 v0, p0
    ...
    .line 3421
    .local v11, r:Lcom/android/internal/telephony/IccRecords;
    if-eqz v11, :cond_0
    ...
    const-string v22, "updateSpnDisplay mEmergencyOnly="
    ...
    const-string v22, " mRadioState.isOn()="
    ...
    .line 3498
    const-string v21, "updateSpnDisplay show mEmergencyOnly"
    ...
    invoke-interface/range {v21 .. v21}, Lcom/mediatek/common/telephony/IServiceStateExt;->getEccPlmnValue()Ljava/lang/String;
    ...
    invoke-static/range {v21 .. v21}, Lcom/android/internal/telephony/uicc/UiccController;->getInstance(I)Lcom/android/internal/telephony/uicc/UiccController;

    move-result-object v21

    invoke-virtual/range {v21 .. v21}, Lcom/android/internal/telephony/uicc/UiccController;->getUiccCard()Lcom/android/internal/telephony/UiccCard;

    move-result-object v20

    .line 3577
    .local v20, uiccCard:Lcom/android/internal/telephony/UiccCard;
    move-object/from16 v0, p0
    ...
    const-string v22, "origin showSpn:"
    ...
    invoke-interface/range {v21 .. v21}, Lcom/mediatek/common/telephony/IServiceStateExt;->allowSpnDisplayed()Z
    ...
    .line 3614
    const-string v21, "For CT test case don\'t show SPN."
    ...
    const-string v21, "android.provider.Telephony.SPN_STRINGS_UPDATED_SIM1"
    ...
    .line 3626
    .local v7, intent_sim1:Landroid/content/Intent;
    new-instance v8, Landroid/content/Intent;

    const-string v21, "android.provider.Telephony.SPN_STRINGS_UPDATED_SIM2"
    ...
    .line 3629
    .local v8, intent_sim2:Landroid/content/Intent;
    ...
    .line 3646
    const-string v21, "updateAllOpertorInfo with spn"
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/internal/telephony/gsm/GSMPhone;->getMySimId()I
    ...
    .line 3666
    const-string v21, "bird"

    const-string v22, " phone.getContext().sendStickyBroadcast(intent_sim1)"
    ...
    .end local v7           #intent_sim1:Landroid/content/Intent;
    .end local v8           #intent_sim2:Landroid/content/Intent;
    :cond_f
    move/from16 v0, v16
    ...
    .end local v20           #uiccCard:Lcom/android/internal/telephony/UiccCard;
    :cond_10
    const/4 v13, 0x2
    ...
    invoke-virtual/range {v17 .. v17}, Lcom/android/internal/telephony/gsm/SIMRecords;->getSIMCPHSOns()Ljava/lang/String;
    ...
    .line 3533
    .restart local v5       #imeiAbnormal:I
    :cond_16
    const/16 v21, 0x2
    ...
    invoke-interface {v0, v10, v1}, Lcom/mediatek/common/telephony/IServiceStateExt;->onUpdateSpnDisplay(Ljava/lang/String;I)Ljava/lang/String;
    ...
    .restart local v7       #intent_sim1:Landroid/content/Intent;
    .restart local v8       #intent_sim2:Landroid/content/Intent;
    .restart local v16       #showSpn:Z
    .restart local v20       #uiccCard:Lcom/android/internal/telephony/UiccCard;
    :cond_1a
    const-string v21, "updateAllOpertorInfo with realPlmn"
    ...
    const-string v22, " phone.getContext().sendStickyBroadcast(intent_sim2)"
