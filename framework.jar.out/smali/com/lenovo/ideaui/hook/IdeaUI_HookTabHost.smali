...
.method public constructor <init>(Landroid/widget/TabHost;II)V
    .locals 9
    .parameter "tabHost"
    .parameter "divider_id"
    .parameter "mTabLayoutId"
...
.method public updateTabTheme(Landroid/widget/TabWidget;)V
    ...
    invoke-virtual {p1, v3}, Landroid/widget/TabWidget;->setBackground(Landroid/graphics/drawable/Drawable;)V

    .line 80
    const v3, 0x30800fc

    invoke-virtual {p1, v3}, Landroid/widget/TabWidget;->setBackgroundResource(I)V

    .line 84
    iget-object v3, p0, Lcom/lenovo/ideaui/hook/IdeaUI_HookTabHost;->mTabHost:Landroid/widget/TabHost;

    invoke-virtual {v3}, Landroid/widget/TabHost;->getRootView()Landroid/view/View;
    ...
    invoke-virtual {p1}, Landroid/widget/TabWidget;->getVisibility()I
