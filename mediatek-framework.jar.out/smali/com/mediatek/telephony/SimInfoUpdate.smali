...
.method private static setColorForNewSim(Ljava/util/List;)V
    ...
    .line 612
    .local v3, pivotSimColor:I
    const/4 v5, 0x4

    .line 613
    .local v5, totalColorNum:I
    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "[setColorForNewSim] SIM num = "
    ...
    invoke-static {v7}, Lcom/mediatek/telephony/SimInfoUpdate;->logd(Ljava/lang/String;)V
    ...
    .line 616
    .local v4, pivotSimInfo:Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    if-eqz v4, :cond_1
    ...
    const-string v8, "[setColorForNewSim] i = "
    ...
    const-string v8, "[setColorForNewSim]lenovo debug operator:"
    ...
    .line 636
    .local v6, valueColor:Landroid/content/ContentValues;
    ...
    .line 637
    sget-object v7, Lcom/mediatek/telephony/SimInfoUpdate;->mContext:Landroid/content/Context;

    invoke-virtual {v7}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v7

    sget-object v8, Lcom/mediatek/telephony/SimInfoManager;->CONTENT_URI:Landroid/net/Uri;
    ...
    const-string v8, "[setColorForNewSim] set slot"
    ...
    .line 614
    .end local v6           #valueColor:Landroid/content/ContentValues;
    :cond_1
    add-int/lit8 v0, v0, 0x1
    ...
    .end local v2           #nSimInsert:I
    .end local v3           #pivotSimColor:I
    .end local v4           #pivotSimInfo:Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    .end local v5           #totalColorNum:I
    :cond_2
    ...
    .restart local v2       #nSimInsert:I
    .restart local v3       #pivotSimColor:I
    .restart local v4       #pivotSimInfo:Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;
    .restart local v5       #totalColorNum:I
    :cond_3
    iget v7, v4, Lcom/mediatek/telephony/SimInfoManager$SimInfoRecord;->mSimSlotId:I
...
.method public static declared-synchronized updateSimInfoByIccId(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v1, v8, v9}, Landroid/provider/Settings$System;->putLong(Landroid/content/ContentResolver;Ljava/lang/String;J)Z
