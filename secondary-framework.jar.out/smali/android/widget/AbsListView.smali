...
.field private mIdeaUI_HookAbsListView:Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;
...
.field private mPinScrollIndicator:Lcom/lenovo/pinscroll/PinScrollIndicator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 843
    .local v1, color:I
    iget-object v9, p0, Landroid/widget/AbsListView;->mIdeaUI_HookAbsListView:Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;

    invoke-virtual {v9, p1, p2}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;->AbsListView(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method static synthetic access$1900(Landroid/widget/AbsListView;)I
    ...
    .prologue
    .line 108
    iget v0, p0, Landroid/view/View;->mLenovo_pinnedScrollY:I
...
.method static synthetic access$2300(Landroid/widget/AbsListView;)Z
    ...
    .prologue
    .line 108
    invoke-direct {p0}, Landroid/widget/AbsListView;->lenovo_canOverSrcroll()Z
...
.method static synthetic access$4400(Landroid/widget/AbsListView;IIIIIIIIZ)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$4900(Landroid/widget/AbsListView;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private initAbsListView()V
    ...
    .line 880
    new-instance v1, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;

    invoke-direct {v1, p0}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;-><init>(Landroid/widget/AbsListView;)V

    iput-object v1, p0, Landroid/widget/AbsListView;->mIdeaUI_HookAbsListView:Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;
    ...
    .line 903
    :cond_0
    invoke-direct {p0}, Landroid/widget/AbsListView;->lenovo_initPinScroll()V
...
.method private lenovo_canOverSrcroll()Z
    .locals 1

    .prologue
    .line 7416
    iget-boolean v0, p0, Landroid/view/View;->mLenovo_isPinScrollOn:Z

    return v0
.end method

.method private lenovo_canShowScrollPin()Z
    .locals 11
    ...
    :cond_0
    :pswitch_0
    iget-object v4, p0, Landroid/widget/AbsListView;->mPinScrollIndicator:Lcom/lenovo/pinscroll/PinScrollIndicator;

    invoke-virtual {v4, v6}, Lcom/lenovo/pinscroll/PinScrollIndicator;->setState(I)V
    ...
    .line 7431
    :pswitch_1
    iget v4, p0, Landroid/view/View;->mLenovo_pinnedScrollY:I
    ...
    iget v7, p0, Landroid/view/View;->mLenovo_pinScrollDistanceMin:I
    ...
    iget-wide v7, p0, Landroid/view/View;->mLenovo_lastVelocityTime:J
    ...
    .line 7463
    :goto_1
    iget-boolean v4, p0, Landroid/view/View;->mLenovo_lastVelocityPinable:Z

    if-eqz v4, :cond_0

    iget-boolean v4, p0, Landroid/view/View;->mLenovo_thisVelocityPinable:Z
    ...
    invoke-virtual {v4, v5}, Lcom/lenovo/pinscroll/PinScrollIndicator;->setState(I)V
    ...
    iget v7, p0, Landroid/widget/AbsListView;->mMaximumVelocity:I
    ...
    .line 7456
    iput-wide v0, p0, Landroid/view/View;->mLenovo_lastVelocityTime:J
    ...
    iget v7, p0, Landroid/view/View;->mLenovo_pinScrollVelocityMax:I
...
.method private lenovo_initPinScroll()V
    .locals 2

    .prologue
    .line 7365
    new-instance v0, Lcom/lenovo/pinscroll/PinScrollIndicator;

    iget-object v1, p0, Landroid/view/View;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/lenovo/pinscroll/PinScrollIndicator;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/widget/AbsListView;->mPinScrollIndicator:Lcom/lenovo/pinscroll/PinScrollIndicator;
    ...
    invoke-static {v0}, Lcom/lenovo/pinscroll/PinScroll;->isSupport(Landroid/content/Context;)Z
...
.method private lenovo_resetPinnedScroll()V
    .locals 1
    ...
    iput v0, p0, Landroid/view/View;->mLenovo_pinnedScrollY:I
...
.method private scrollIfNeeded(I)V
    ...
    invoke-direct/range {p0 .. p0}, Landroid/widget/AbsListView;->lenovo_canOverSrcroll()Z
    ...
    .end local v25           #newScroll:I
    .end local v26           #oldScroll:I
    :cond_1c
    move-object/from16 v0, p0
    ...
    .line 3430
    .restart local v25       #newScroll:I
    .restart local v26       #oldScroll:I
    :cond_1d
    const/16 v24, -0x1
...
.method private startScrollIfNeeded(I)Z
    ...
    iget v11, p0, Landroid/view/View;->mLenovo_pinnedScrollY:I
...
.method public IdeaUI_SetRounderCorner(ZZ)V
    ...
    .prologue
    .line 872
    iget-object v0, p0, Landroid/widget/AbsListView;->mIdeaUI_HookAbsListView:Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;

    invoke-virtual {v0, p1, p2}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;->IdeaUI_SetRounderCorner(ZZ)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 4136
    iget-object v8, p0, Landroid/widget/AbsListView;->mIdeaUI_HookAbsListView:Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;

    invoke-virtual {v8, p1}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;->draw(Landroid/graphics/Canvas;)Z
    ...
    invoke-virtual {v8}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;->getPath()Landroid/graphics/Path;

    move-result-object v8

    sget-object v9, Landroid/graphics/Region$Op;->REPLACE:Landroid/graphics/Region$Op;

    invoke-virtual {p1, v8, v9}, Landroid/graphics/Canvas;->clipPath(Landroid/graphics/Path;Landroid/graphics/Region$Op;)Z
    ...
    :goto_0
    invoke-direct {p0}, Landroid/widget/AbsListView;->lenovo_canShowScrollPin()Z
    ...
    .line 4158
    iget-object v8, p0, Landroid/widget/AbsListView;->mPinScrollIndicator:Lcom/lenovo/pinscroll/PinScrollIndicator;

    invoke-virtual {v8, p1}, Lcom/lenovo/pinscroll/PinScrollIndicator;->draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p1, v3, v11, v7, v8}, Landroid/graphics/Canvas;->clipRect(IIII)Z
...
.method protected lenovo_calcOverDistance(Landroid/view/MotionEvent;)V
    .locals 4
    .parameter "ev"
    ...
    invoke-static {v1}, Lcom/lenovo/pinscroll/PinScroll;->isOn(Landroid/content/Context;)Z

    move-result v1

    iput-boolean v1, p0, Landroid/view/View;->mLenovo_isPinScrollOn:Z

    .line 7385
    iget v1, p0, Landroid/view/View;->mLenovo_pinScrollDistanceMin:I
    ...
    iget-boolean v1, p0, Landroid/view/View;->mLenovo_isPinScrollOn:Z
    ...
    .line 7395
    :goto_0
    iput-boolean v3, p0, Landroid/view/View;->mLenovo_lastVelocityPinable:Z

    .line 7396
    iput-boolean v3, p0, Landroid/view/View;->mLenovo_thisVelocityPinable:Z
...
.method protected onAttachedToWindow()V
    ...
    .line 2793
    invoke-virtual {p0, v3}, Landroid/widget/AbsListView;->setOverScrollMode(I)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v8}, Landroid/widget/AbsListView;->findMotionRow(I)I

    move-result v2

    .line 4300
    invoke-virtual {p0, p1}, Landroid/widget/AbsListView;->lenovo_calcOverDistance(Landroid/view/MotionEvent;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget v5, p0, Landroid/view/View;->mLenovo_pinnedScrollY:I
    ...
    .line 2104
    invoke-direct {p0}, Landroid/widget/AbsListView;->lenovo_resetPinnedScroll()V

    .line 2106
    invoke-virtual {p0}, Landroid/widget/AbsListView;->invalidate()V

    .line 2112
    .end local v2           #needRedraw:Z
    :cond_2
    invoke-super/range {p0 .. p5}, Landroid/widget/AdapterView;->onLayout(ZIIII)V

    .line 2113
    iput-boolean v4, p0, Landroid/widget/AdapterView;->mInLayout:Z
    ...
    invoke-virtual {v4}, Landroid/widget/AbsListView$RecycleBin;->markChildrenDirty()V
    ...
    iget v5, p0, Landroid/widget/AdapterView;->mOldItemCount:I
    ...
    invoke-virtual {v4, v5, v6}, Landroid/widget/FastScroller;->onItemCountChanged(II)V
    ...
    .line 2133
    iget-object v3, p0, Landroid/widget/AbsListView;->mIdeaUI_HookAbsListView:Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;

    invoke-virtual {v3}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;->onLayout()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 3832
    invoke-direct/range {p0 .. p0}, Landroid/widget/AbsListView;->lenovo_resetPinnedScroll()V
    ...
    iget v0, v0, Landroid/view/View;->mLenovo_pinScrollDistanceMin:I
    ...
    iget v0, v0, Landroid/view/View;->mLenovo_pinScrollVelocityMax:I
    ...
    iget-boolean v0, v0, Landroid/view/View;->mLenovo_lastVelocityPinable:Z
    ...
    iput v0, v1, Landroid/view/View;->mLenovo_pinnedScrollY:I
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, p1}, Lcom/lenovo/ideaui/hook/IdeaUI_HookAbsListView;->setAdapter(Landroid/widget/ListAdapter;)V
