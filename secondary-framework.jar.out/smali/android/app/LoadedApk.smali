...
.method public makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    .prologue
    .line 484
    iget-object v6, p0, Landroid/app/LoadedApk;->mApplication:Landroid/app/Application;
    ...
    iget-object v1, v6, Landroid/content/pm/ApplicationInfo;->className:Ljava/lang/String;
    ...
    invoke-virtual {v2, p0, v6, v7}, Landroid/app/ContextImpl;->init(Landroid/app/LoadedApk;Landroid/os/IBinder;Landroid/app/ActivityThread;)V
    ...
    invoke-virtual {v6, v3, v1, v2}, Landroid/app/Instrumentation;->newApplication(Ljava/lang/ClassLoader;Ljava/lang/String;Landroid/content/Context;)Landroid/app/Application;
    ...
    .line 505
    .local v5, er:Ljava/lang/NullPointerException;
    ...
    const-string v8, "Unable to load class "
    ...
    .line 510
    .end local v5           #er:Ljava/lang/NullPointerException;
    :catch_2
    move-exception v4
    ...
    invoke-virtual {v6, v0, v4}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
