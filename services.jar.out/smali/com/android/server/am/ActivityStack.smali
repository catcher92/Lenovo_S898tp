...
.field static final FPSLIST:Ljava/util/ArrayList; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/am/ActivityStack;->FPSLIST:Ljava/util/ArrayList;

    .line 357
    sget-object v0, Lcom/android/server/am/ActivityStack;->FPSLIST:Ljava/util/ArrayList;
    ...
    const-string v1, "com.lenovo.mcamera"
    ...
    const-string v1, "com.lenovo.videotalk.phone"
...
.method private final completePauseLocked()V
    ...
    .line 1497
    :cond_0
    const-string v6, "Reduce_FPS"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "[ Reduce FPS ][ ActivityManager ] :: completePauseLocked, restore1 FPS to 60, processName: "
    ...
    .line 1499
    invoke-static {v11}, Landroid/view/Choreographer;->setVsyncType(Z)V
    ...
    invoke-virtual {p0, v3, v11, v9, v6}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
...
.method final activityIdleInternal(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 4113
    .local v24, res:Lcom/android/server/am/ActivityRecord;
    const/16 v28, 0x0

    .line 4114
    .local v28, stops:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    const/16 v19, 0x0
    ...
    .line 4121
    .local v25, sendThumbnail:Landroid/app/IApplicationThread;
    const/16 v16, 0x0
    ...
    .local v21, i:I
    :goto_0
    sget-object v2, Lcom/android/server/am/ActivityStack;->FPSLIST:Ljava/util/ArrayList;
    ...
    sget-object v3, Lcom/android/server/am/ActivityStack;->FPSLIST:Ljava/util/ArrayList;
    ...
    .line 4185
    const-string v2, "Reduce_FPS"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "[ Reduce FPS ][ ActivityManager ] :: activityIdleInternal, set FPS to 40, packageName: "
    ...
    invoke-static {v2}, Landroid/view/Choreographer;->setVsyncType(Z)V
    ...
    const-string v5, "[ Reduce FPS ][ ActivityManager ] :: activityIdleInternal, set FPS to 60, packageName: "
    ...
    .local v30, thumbnails:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    :try_start_3
    move-object/from16 v0, p0
    ...
    .line 4232
    .end local v30           #thumbnails:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    ...
    .local v27, startingUsers:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/UserStartedState;>;"
    :try_start_5
    move-object/from16 v0, p0
    ...
    .line 4240
    .end local v27           #startingUsers:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/UserStartedState;>;"
    ...
    .end local v29           #thumbnails:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    .restart local v30       #thumbnails:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    :catchall_5
    move-exception v2
    ...
    .end local v26           #startingUsers:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/UserStartedState;>;"
    .restart local v27       #startingUsers:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/UserStartedState;>;"
    :catchall_6
    move-exception v2
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    iget-object v3, v3, Lcom/android/server/am/ActivityManagerService;->mActivityController:Landroid/app/IActivityController;
    ...
    iget-object v4, v3, Lcom/android/server/am/ActivityManagerService;->mActivityController:Landroid/app/IActivityController;
    ...
    invoke-interface {v4, v3, v7}, Landroid/app/IActivityController;->activityStarting(Landroid/content/Intent;Ljava/lang/String;)Z
    :try_end_1
    ...
    iput-object v4, v3, Lcom/android/server/am/ActivityManagerService;->mActivityController:Landroid/app/IActivityController;
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILjava/lang/String;Landroid/os/ParcelFileDescriptor;Landroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;Landroid/os/Bundle;I)I
    ...
    .line 3677
    .local v31, mMobileManager:Lcom/mediatek/common/mom/IMobileManagerService;
    ...
    .line 3680
    const-string v35, "sub-permission.MAKE_CALL"
    ...
    .line 3682
    .local v36, phoneNumber:Ljava/lang/String;
    ...
    .line 3684
    .end local v36           #phoneNumber:Ljava/lang/String;
    :cond_1
    invoke-static {}, Landroid/os/Binder;->getCallingUid()I
    ...
    .end local v31           #mMobileManager:Lcom/mediatek/common/mom/IMobileManagerService;
    ...
    .line 3703
    .local v26, categories:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    ...
    invoke-static {v3, v5, v6, v0}, Lcom/lenovo/smart/SmartAPI;->addApplicationStartLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V

    .line 3722
    .end local v26           #categories:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    .end local v29           #flags:I
    .end local v42           #startType:I
    :cond_6
    move-object/from16 v0, p0
    ...
    .restart local v39       #realCallingPid:I
    :cond_13
    const-string v3, "ActivityManager"
